      ...
      <div className="max-w-none space-y-32">
        ...
        <div className="text-center mb-12">
          <div className="mb-4 space-x-4">
            ...
            <a href="#hires-bg" className="inline-flex items-center text-lg text-gray-600 hover:text-gray-700">
              With Background Version
            </a>
          </div>
          <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-2">
            High Resolution Logo Assets (Transparent)
          </h1>
          <p className="text-gray-600 dark:text-gray-400 text-lg">
            Rendered at massive sizes for high-quality screenshots
          </p>
        </div>
        ...
        <div className="text-center py-16">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-gray-600 dark:text-gray-400 space-y-2">
              ...
              <p>• Images will be crisp and ready for any high-resolution use</p>
            </div>
          </div>
        </div>
